...
// ข้อมูลเริ่มต้นสำหรับตลาด (Mock Data)
    ...
    floors: [
      {
        ...
        locks: [
          // ตัวอย่างล็อกแบบ Polygon (สี่เหลี่ยม A01)
          {
            ...
            price: 500,
            area: 4.5,
            status: "available", // สถานะ: available (ว่าง), booked (จองแล้ว), blocked (ปิดปรับปรุง)
            isPolygon: true, // ระบุว่าเป็นล็อกที่วาดด้วย Polygon
            color: "#4ADE80", // สีพื้นหลังของล็อก
            fontSize: 12, // ขนาดตัวอักษร
            borderRadius: 2,
            // พิกัดจุดวาด (จำลอง) สำหรับสร้างรูปทรงล็อก
            points: [
              { x: 20, y: 20 },
              { x: 30, y: 20 },
              { x: 30, y: 30 },
            ...
            x: 25, y: 25 // จุดกึ่งกลางสำหรับวางป้ายชื่อ (Label)
          },
          // ตัวอย่างล็อกแบบ Polygon (A02)
          {
            ...
            price: 600,
            area: 5.0,
            status: "booked", // สถานะล็อกนี้ถูกจองไปแล้ว
            isPolygon: true,
            color: "#F472B6", // สีชมพู
            fontSize: 12,
            borderRadius: 5,
