...
export default function MarketManage({ markets, setMarkets }) {
  ...
  const styles = {
    ...
    input: { width: '100%', padding: '10px', border: '1px solid #E5E5EA', borderRadius: '10px', fontSize: '0.9rem', background: '#F2F2F7', outline: 'none' },
    textarea: { width: '100%', padding: '10px', border: '1px solid #E5E5EA', borderRadius: '10px', fontSize: '0.9rem', background: '#F2F2F7', outline: 'none', resize: 'vertical', minHeight: '60px' },
    ...
    editTextarea: { width: '100%', padding: '6px 8px', border: '1px solid #007AFF', borderRadius: '8px', fontSize: '0.85rem', marginBottom: '10px', minHeight: '50px', resize: 'vertical' },
