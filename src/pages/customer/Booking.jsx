...
export default function Booking({ markets, bookings, setBookings, user }) {
  ...
  // 🔥 FIX: อ่านขนาดแผนที่ Admin จาก Local Storage เพื่อใช้เป็น MAX WIDTH (สำหรับแสดงผลให้ตรงกับหน้า Admin)
  ...
  // Helper: ฟังก์ชันวาดเส้นโค้ง (Path Smoother) สำหรับวาดรูปทรง SVG
  ...
  // ตรวจสอบสถานะของล็อก (ว่าง / จองแล้ว / รอตรวจสอบ)
